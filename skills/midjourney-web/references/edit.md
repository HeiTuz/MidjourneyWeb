...
Smart Select may isolate a face or expand from a jacket click to the whole person. Inspect hair, hands, clothing and held objects before applying either erase action; add Include/Exclude points or clear the points and start again when the scope is wrong. Do not rely on prompt wording to constrain a larger mask. Verify the green overlay becomes checkerboard before Submit Edit, then assess both the requested change and style continuity. One live whole-person Smart Select edit kept the scene layout and changed clothing, but its regenerated person became much more photographic than the painted source. After Undo, selection points or green highlighting may remain even though pixels are restored. Clear selection points separately and visually check the restored canvas before the next operation.
